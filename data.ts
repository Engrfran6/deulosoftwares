import {BlogPost, PortfolioItem, ServiceDetail} from './types';
...
export const servicesData: ServiceDetail[] = [
  {
    ...
    icon: 'Globe',
    heroImage: '/service-details.png?height=600&width=1200',
    overview:
    ...
    caseStudies: [
      {
        ...
        image: '/service-details.png?height=300&width=400',
